...
hello_gcc_x32_debug:     file format elf32-i386
...
000011cd <main>:
    ...
    11de:	53                   	push   ebx
    11df:	51                   	push   ecx
    11e0:	e8 28 00 00 00       	call   120d <__x86.get_pc_thunk.ax>
...
0000120d <__x86.get_pc_thunk.ax>:
...
0000129c <_fini>:
    ...
    12a4:	e8 27 fe ff ff       	call   10d0 <__x86.get_pc_thunk.bx>
