...
hello_clang_x32_stripped:     file format elf32-i386
...
08049000 <.init>:
 ...
 8049008:	e8 a3 00 00 00       	call   80490b0 <__libc_start_main@plt+0x60>
 804900d:	81 c3 f3 2f 00 00    	add    ebx,0x2ff3
 8049013:	8b 83 fc ff ff ff    	mov    eax,DWORD PTR [ebx-0x4]
 8049019:	85 c0                	test   eax,eax
 804901b:	74 02                	je     804901f <printf@plt-0x21>
...
08049040 <printf@plt>:
 ...
 804904b:	e9 e0 ff ff ff       	jmp    8049030 <printf@plt-0x10>

08049050 <__libc_start_main@plt>:
 8049050:	ff 25 10 c0 04 08    	jmp    DWORD PTR ds:0x804c010
 8049056:	68 08 00 00 00       	push   0x8
 804905b:	e9 d0 ff ff ff       	jmp    8049030 <printf@plt-0x10>
...
08049060 <.text>:
 ...
 804906d:	54                   	push   esp
 804906e:	52                   	push   edx
 804906f:	e8 23 00 00 00       	call   8049097 <__libc_start_main@plt+0x47>
 ...
 80490ca:	74 24                	je     80490f0 <__libc_start_main@plt+0xa0>
 80490cc:	b8 00 00 00 00       	mov    eax,0x0
 80490d1:	85 c0                	test   eax,eax
 80490d3:	74 1b                	je     80490f0 <__libc_start_main@plt+0xa0>
 80490d5:	55                   	push   ebp
 ...
 8049116:	74 20                	je     8049138 <__libc_start_main@plt+0xe8>
 8049118:	ba 00 00 00 00       	mov    edx,0x0
 804911d:	85 d2                	test   edx,edx
 804911f:	74 17                	je     8049138 <__libc_start_main@plt+0xe8>
 8049121:	55                   	push   ebp
 ...
 804914b:	75 1b                	jne    8049168 <__libc_start_main@plt+0x118>
 804914d:	55                   	push   ebp
 804914e:	89 e5                	mov    ebp,esp
 8049150:	83 ec 08             	sub    esp,0x8
 8049153:	e8 68 ff ff ff       	call   80490c0 <__libc_start_main@plt+0x70>
 ...
 8049174:	eb 8a                	jmp    8049100 <__libc_start_main@plt+0xb0>
 ...
 80491c4:	55                   	push   ebp
 80491c5:	e8 6b 00 00 00       	call   8049235 <__libc_start_main@plt+0x1e5>
 ...
 80491dc:	e8 1f fe ff ff       	call   8049000 <printf@plt-0x40>
 ...
 80491f2:	74 29                	je     804921d <__libc_start_main@plt+0x1cd>
 ...
 804921b:	75 e3                	jne    8049200 <__libc_start_main@plt+0x1b0>
...
0804923c <.fini>:
 ...
 8049244:	e8 67 fe ff ff       	call   80490b0 <__libc_start_main@plt+0x60>
